...
bech32_templates = [
  ...
  ('out',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('out',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('out',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('out',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tout',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tout',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tout',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tout',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tout',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tout',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tout',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tout',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rout',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rout',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rout',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rout', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tout',   17, 32, Encoding.BECH32M, False, False, False),
  ('rout',  3,  1, Encoding.BECH32M, False, False, False),
  ('out',   15, 41, Encoding.BECH32M, False, False, False),
  ('tout',    0, 16, Encoding.BECH32,  False, False, False),
  ('rout',  0, 32, Encoding.BECH32,  True,  False, False),
  ('out',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tout',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rout',  0, 20, Encoding.BECH32,  False, False, True),
  ('out',    0, 20, Encoding.BECH32M, False, False, False),
  ('tout',    0, 32, Encoding.BECH32M, False, False, False),
  ('rout',  0, 20, Encoding.BECH32M, False, False, False),
  ('out',    1, 32, Encoding.BECH32,  False, False, False),
  ('tout',    2, 16, Encoding.BECH32,  False, False, False),
  ('rout', 16, 20, Encoding.BECH32,  False, False, False),
]
