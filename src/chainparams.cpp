...
// Copyright (c) 2025 The Outcoin Core developers
...
{
    const char* pszTimestamp = "Outcoin: The future of decentralized finance starts today!";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1750476281, 1758116, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000c0b033ecfa18d2ae708173e206a5e1aab10e5e010e362b4f4986cae06df"));
        assert(genesis.hashMerkleRoot == uint256S("0xeb6a8d6ed70a04ef85d4663e9b0b91459f7390e64ded29f52884a013d1cffa0c"));
...
public:
    CTestNetParams() {
        ...
        consensus.fPowNoRetargeting = false;
        consensus.nRuleChangeActivationThreshold = 3780; // 75% for testchains
        consensus.nMinerConfirmationWindow = 5040; // nPowTargetTimespan / nPowTargetSpacing
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].bit = 28;
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nStartTime = Consensus::BIP9Deployment::NEVER_ACTIVE;
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;
        ...
        vSeeds.emplace_back("testnet-seed-1.outcoin.org");
        vSeeds.emplace_back("testnet-seed-2.outcoin.org");
        vSeeds.emplace_back("testnet-seed-3.outcoin.org");
