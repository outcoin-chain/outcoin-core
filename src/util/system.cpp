...
const char * const BITCOIN_CONF_FILENAME = "outcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Outcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Outcoin";
#else
    // Unix-like
    return pathRet / ".outcoin";
#endif
#endif
}
