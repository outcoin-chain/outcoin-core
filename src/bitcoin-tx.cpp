...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " outcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  outcoin-tx [options] <hex-tx> [commands]  Update hex-encoded outcoin transaction\n" +
            "or:     outcoin-tx [options] -create [commands]   Create hex-encoded outcoin transaction\n" +
            "\n";
