# Support for Output Descriptors in Outcoin Core

Since Outcoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `out1...` for mainnet or `tout1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing Outcoin Core wallets, a convenience function `combo` is
