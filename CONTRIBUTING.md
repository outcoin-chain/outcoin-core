Contributing to Outcoin Core
============================

The Outcoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Outcoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/outcoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to outcoin-qt
...
The following applies to code changes to the Outcoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Outcoin
Network Protocol consensus changes.

Whether a pull request is merged into Outcoin Core rests with the project merge
...
Patches that change Outcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Outcoin consensus, it must have been
...
The project leader is the release manager for each Outcoin Core release.
