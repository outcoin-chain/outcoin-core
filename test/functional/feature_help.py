...
"""Verify that starting outcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start outcoin with -h for help text")
        ...
        self.log.info("Start outcoin with -version for version information")
        ...
        self.log.info("Start outcoind with -fakearg to make sure it does not start")
