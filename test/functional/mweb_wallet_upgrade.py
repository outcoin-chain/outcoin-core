#!/usr/bin/env python3
# Copyright (c) 2021 The Outcoin Core developers
...
from test_framework.out_util import create_non_hd_wallet, setup_mweb_chain
...
class MWEBWalletUpgradeTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        #
        # Create a non-HD wallet using an older outcoin core version
        #
